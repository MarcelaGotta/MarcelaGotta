...
var es = {
    ...
    WELCOME: 'bienvenido',
    HI: 'Hola',
    MEWELCOME: "Soy desarrolladora Front-End freelance, con más de 7 años de experiencia profesional, he trabajado en varios proyectos con diferentes roles. Actualmente vivo en Madrid",
    ILOVE: 'yoAmo',
    ...
    AND: 'y',
    MEDESCRIPTION2: 'Tengo experiencia desarrollando de sitios web totalmente adaptables a cualquier dispositivo', 
    MEDESCRIPTION3: 'basandome en los estándares W3C. Desarrollo plantillas para diferentes CMS, y poseo grandes conocimientos en ',
    MEDESCRIPTION4: "En todos los sitios que realizo doy lo mejor de mi, y ofrezco sitios web con código limpio y optimizados para un mejor posicionamiento en buscadores",
    SKILLS: 'Habilidades',
